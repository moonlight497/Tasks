...
public class Inner {
    ...
    public Inner(String country, String city) {
    ...
    private class SuperUser {
        ...
        public String getDescription() {
            return String.format("My name is %s. I'm from %s in %s.", this.name, Inner.this.city,Inner.this.country);
        }
    }

    public static void main(String[] args) {
        Inner solution = new Inner("the United States", "Seattle");
